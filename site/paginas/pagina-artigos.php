<div class="container w-auto">
    ...
    <div class="row">
        <div class="col mb-3 mt-3">
            ...
            <small class="mb-3 "> <strong>Willson, Ralph | 25.02.2021 | rw.greenwood@gmail.com</strong></small> <br />
            <small class="mb-3 "> <strong>Programação Web | Developer Senior</strong></small>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col w-auto ">
            <img class="rounded float-left img-thumbnail mr-2 mb-2" src="http://placehold.it/400x500" alt="Imagem de artigo">
            <div>
